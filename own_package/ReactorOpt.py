...
def optimize_reactor(storedata, sleep, pso_gen, ga, type, basecase, limitreactorsize):
    Hycase = init_hysys()
...
def run_ReactorOpt(storedata, sleep, pso_gen, ga, type, sensitivityanalysis, basecase, limitreactorsize):
    if storedata:
        best = optimize_reactor(storedata=storedata, sleep=sleep, pso_gen=pso_gen, ga=ga, type=type, basecase=basecase,
